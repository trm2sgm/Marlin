...
#define STRING_CONFIG_H_AUTHOR "Michael" // Who made the changes.
...
// Choose the name from boards.h that matches your setup
  ...
  #define MOTHERBOARD BOARD_EZT3D_T1
#endif
...
#define CUSTOM_MACHINE_NAME "GoliPrint"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "f72c60f0-12a3-4eb1-980d-e567ffd53f40"
...
#define DELTA
  ...
  #define PRINTABLE_RADIUS       180.0    // (mm)

  // Maximum reachable area
  #define DELTA_MAX_RADIUS       170.0    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 185.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 318.20             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, -0.35 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 102.5              // (mm) Get this value from G33 auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 95 }
...
#define TFT_GENERIC
  ...
  #define TFT_PIXEL_OFFSET_X 2
  #define TFT_PIXEL_OFFSET_Y 3
 ...
 */
#define TFT_ROTATION TFT_ROTATE_90_MIRROR_Y
